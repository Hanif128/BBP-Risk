    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <select id="sumber" name="sumber">
                <option value="">-- Pilih --</option>
                <option value="Eksternal" <?php if ($risiko['sumber'] == 'Eksternal') echo 'selected'; ?>>Eksternal</option>
                <option value="Internal" <?php if ($risiko['sumber'] == 'Internal') echo 'selected'; ?>>Internal</option>
                <option value="Eksternal dan Internal" <?php if ($risiko['sumber'] == 'Eksternal dan Internal') echo 'selected'; ?>>Eksternal dan Internal</option>
            </select>
