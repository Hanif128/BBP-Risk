...
// Query untuk mengambil nama dan username pengguna yang sedang login
$sql_user = "SELECT nama, username FROM users WHERE username = ?";
$stmt = $conn->prepare($sql_user);
$stmt->bind_param("s", $logged_in_user); // Menghindari SQL Injection
$stmt->execute();
$result_user = $stmt->get_result();

$user_data = $result_user->fetch_assoc(); // Hanya satu baris data yang diambil
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <?php if ($user_data): ?>
                <h1>Selamat Datang, <?php echo htmlspecialchars($user_data['nama']); ?>!</h1>
            <?php else: ?>
